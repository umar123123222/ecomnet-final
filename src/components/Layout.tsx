...
import { Home, Package, Truck, RotateCcw, Users, Settings, Bell, Moon, Sun, Shield, MapPin, LogOut, ChevronDown, Box, Building2, ArrowRightLeft, UserCog, Ship, User, UserCircle, MapPinned, BellRing, Lock, PackagePlus, PackageCheck, PackageX, TruckIcon, PackageSearch, Plus, ArrowLeftRight } from "lucide-react";
...
const Layout = () => {
  ...
  const getIcon = (iconName: string) => {
    const icons = {
      Home, Package, Truck, RotateCcw, Users, Settings, Shield, MapPin, Box, Building2, ArrowRightLeft, UserCog,
      Ship, User, UserCircle, MapPinned, BellRing, Lock, PackagePlus, PackageCheck, PackageX, TruckIcon, PackageSearch, Plus, ArrowLeftRight
    };

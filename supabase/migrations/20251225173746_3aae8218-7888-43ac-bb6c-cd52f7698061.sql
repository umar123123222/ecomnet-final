-- Fix: Exclude bundle products from stock movements and inventory deduction
-- Bundle products should NOT have inventory records or stock movements - only their components should
...
BEGIN
  ...
  WHERE oi.order_id = v_order.id
    ...
    AND (p.is_bundle = false OR p.is_bundle IS NULL);  -- Exclude bundle products

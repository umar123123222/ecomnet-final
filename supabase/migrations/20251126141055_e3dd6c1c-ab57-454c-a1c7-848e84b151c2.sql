-- Fix COALESCE type mismatch in rapid_dispatch_order function
...
BEGIN
  ...
  -- Determine courier (cast ENUM to TEXT to fix type mismatch)
  v_final_courier_name := COALESCE(p_courier_name, v_order.courier::text, 'Unknown');

...
-- STEP 5: Recalculate daily_dispatch_summaries for affected dates
-- First, clear for Dec 26-27
DELETE FROM daily_dispatch_summaries 
WHERE summary_date >= '2024-12-26' AND summary_date <= '2024-12-27';

-- Recalculate using subquery to avoid nested aggregates
...
FROM (
  ...
  WHERE sm.movement_type = 'sale'
    AND DATE(sm.created_at AT TIME ZONE 'Asia/Karachi') IN ('2024-12-26', '2024-12-27')
